      ...
      <div className="bg-[#1A1D29] border border-[#4E5564] rounded-xl p-6">
        ...
        <div className="space-y-4">
          {matches.map((match, idx) => (
            <div
              key={idx}
              className="bg-[#2a2d38] border border-[#4E5564] rounded-lg p-5 hover:border-[#B5A593] transition-colors"
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-2xl font-bold text-[#E07A5F]">#{idx + 1}</span>
                    <div>
                ...
                <div className="text-right">
                  <div className="text-3xl font-bold text-[#B5A593]">
              ...
              {match.narrative?.funny_joke && (
                <div className="mt-3 bg-[#2a2d38] rounded-lg p-3 border-l-2 border-[#f59e0b]">
                  <p className="text-base text-gray-300 italic leading-relaxed">😄 {match.narrative.funny_joke}</p>
                </div>
              )}
            </div>
          ))}
      ...
      <div className="bg-[#1A1D29] border border-[#4E5564] rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {Object.entries(userVector).slice(0, 8).map(([key, value]) => (
            <div key={key} className="bg-[#2a2d38] rounded-lg p-3 text-center">
